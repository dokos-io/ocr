...
from etransactions.common.text import aws_textract_to_docx_and_attach
from etransactions.etransactions.doctype.ocr_request.aws_textract import AWSTextractText
...
class OCRGenericTextTranscription(Document):
	...
	def tick(self):
		try:
			...
			self.log_error()
			frappe.msgprint("An error occurred while processing the eTransactions request")
