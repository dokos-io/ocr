(() => {
  ...
  // ../etransactions/etransactions/public/js/dashboard/dashboard_manager.js
  frappe.provide("etransactions.ocr_dashboard");
  etransactions.ocr_dashboard.DashboardManager = class DashboardManager {
    constructor(opts) {
    ...
    async get_pending_invoices() {
      let pending_invoices = await frappe.call({
        method: "etransactions.etransactions.doctype.ocr_reconciliation_dashboard.ocr_reconciliation_dashboard.get_pending_invoices",
        args: {
    ...
    render_actions_panel() {
      this.actions_panel = new etransactions.ocr_dashboard.ActionsPanelManager({
...
`], ...formatTraceEntry(entry));
 ...
 If you want to mount another app on the same host container, you need to unmount the previous app by calling \`app.unmount()\` first.`);
            ...
            if (true) {
              context.reload = () => {
                render3(cloneVNode(vnode), rootContainer, namespace);
              };
            }
  ...
  function renderComponentRoot(instance) {
    ...
    try {
      if (vnode.shapeFlag & 4) {
        ...
        result = normalizeVNode(render3.call(thisProxy, proxyToUse, renderCache, true ? shallowReadonly(props) : props, setupState, data, ctx));
...
Component that was made reactive: `, type);
  ...
  // ../builder/node_modules/@vue/runtime-dom/dist/runtime-dom.esm-bundler.js
...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  // sfc-script:/home/chdecultot/v4-bench/apps/etransactions/etransactions/public/js/dashboard/actions_panel/Field.vue?type=script
  var Field_default = {
    __name: "Field",
    props: ["df", "modelValue"],
    emits: ["update:modelValue", "rowChecked"],
    setup(__props, { expose, emit: emits }) {
      expose();
      const props = __props;
      const vModel = computed2({
        get() {
      ...
      const refreshInput = () => {
        ...
        let df = __spreadValues({}, props.df);
        if (!df.read_only) {
          df.onchange = () => {
      ...
      watch(() => {
        var _a, _b, _c, _d, _e;
        return [props.df, (_a = props.df) == null ? void 0 : _a.label, (_b = props.df) == null ? void 0 : _b.description, (_c = props.df) == null ? void 0 : _c.reqd, (_d = props.df) == null ? void 0 : _d.read_only, (_e = props.df) == null ? void 0 : _e.data];
      }, refreshInput);
      watch(vModel, () => {
        var _a;
        (_a = fieldObject.value) == null ? void 0 : _a.set_value(vModel.value);
      });
      const __returned__ = { props, emits, vModel, fieldObject, fieldWrapper, refreshInput, onMounted, onUpdated, ref, watch, computed: computed2 };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };

  // sfc-template:/home/chdecultot/v4-bench/apps/etransactions/etransactions/public/js/dashboard/actions_panel/Field.vue?type=template
  var _hoisted_1 = { ref: "fieldWrapper" };
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("div", _hoisted_1, null, 512);
  }

  // ../etransactions/etransactions/public/js/dashboard/actions_panel/Field.vue
  Field_default.render = render;
  Field_default.__file = "../etransactions/etransactions/public/js/dashboard/actions_panel/Field.vue";
  var Field_default2 = Field_default;

  // sfc-script:/home/chdecultot/v4-bench/apps/etransactions/etransactions/public/js/dashboard/actions_panel/MatchTab.vue?type=script
  var MatchTab_default = {
    __name: "MatchTab",
    props: {
      panel_manager: {
        type: Object,
    ...
    setup(__props, { expose }) {
      ...
      const document_types = computed2(() => {
      ...
      async function get_matching_vouchers() {
        let matching_vouchers = await frappe.call({
          method: "etransactions.etransactions.doctype.ocr_reconciliation_dashboard.ocr_reconciliation_dashboard.get_matching_documents",
          args: {
      ...
      async function get_children_rows(rows) {
        return Promise.all(rows.map(async (row) => {
          ...
          const doc2 = frappe.get_doc(reference_doctype, document_name);
          child_rows = doc2.items.map((i) => {
      ...
      function button_click() {
        frappe.call({
          method: "etransactions.etransactions.doctype.ocr_reconciliation_dashboard.ocr_reconciliation_dashboard.create_purchase_invoice",
          args: {
            ocr_request: props.transaction.name,
      ...
      const __returned__ = { props, filters_state, vouchers, items, items_fields, hide_items_table, purchase_order, purchase_receipt, selected_rows, document_types, vouchers_fields, get_matching_vouchers, voucher_checked, get_children_rows, button_click, ref, Field: Field_default2, computed: computed2 };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };

  // sfc-template:/home/chdecultot/v4-bench/apps/etransactions/etransactions/public/js/dashboard/actions_panel/MatchTab.vue?type=template
  var _hoisted_12 = { class: "my-8 d-flex" };
  var _hoisted_2 = { class: "my-8" };
  var _hoisted_3 = { class: "my-8" };
  var _hoisted_4 = { class: "my-8 text-right" };
  function render2(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("div", null, [
      createBaseVNode("div", _hoisted_12, [
        createVNode($setup["Field"], {
          df: { fieldtype: "Check", fieldname: "purchase_order", label: _ctx.__("Purchase Order") },
          "model-value": $setup.purchase_order
        }, null, 8, ["df", "model-value"]),
        createVNode($setup["Field"], {
          df: { fieldtype: "Check", fieldname: "purchase_receipt", label: _ctx.__("Purchase Receipt") },
          "model-value": $setup.purchase_receipt,
          class: "ml-5"
        }, null, 8, ["df", "model-value"])
      ]),
      createBaseVNode("div", _hoisted_2, [
        createVNode($setup["Field"], {
          df: { fieldtype: "Table", fieldname: "vouchers", label: _ctx.__("Select matching documents"), fields: $setup.vouchers_fields, data: $setup.vouchers, cannot_add_rows: true },
          onRowChecked: $setup.voucher_checked
        }, null, 8, ["df"])
      ]),
      createBaseVNode("div", _hoisted_3, [
        createVNode($setup["Field"], {
          df: { fieldtype: "Table", fieldname: "items", label: _ctx.__("Select matching documents"), fields: $setup.items_fields, hidden: $setup.hide_items_table, data: $setup.items }
        }, null, 8, ["df"])
      ]),
      createBaseVNode("div", _hoisted_4, [
        createVNode($setup["Field"], {
          df: { fieldtype: "Button", fieldname: "submit", label: _ctx.__("Create a Purchase Invoice"), primary: true, click: () => {
            $setup.button_click();
          } }
        }, null, 8, ["df"])
      ])
  ...
  // ../etransactions/etransactions/public/js/dashboard/actions_panel/MatchTab.vue
  MatchTab_default.render = render2;
  MatchTab_default.__file = "../etransactions/etransactions/public/js/dashboard/actions_panel/MatchTab.vue";
  var MatchTab_default2 = MatchTab_default;

  // ../etransactions/etransactions/public/js/dashboard/actions_panel/actions_panel_manager.js
  frappe.provide("etransactions.ocr_dashboard");
  etransactions.ocr_dashboard.ActionsPanelManager = class ActionsPanelManager {
    constructor(opts) {
      Object.assign(this, opts);
      this.make();
    }
    ...
    render_tabs() {
      ...
      ["Details", "Match Voucher", "Create Voucher"].forEach((tab) => {
        ...
        $tab_link.on("click", () => {
          ...
          if (tab == "Details") {
            new etransactions.ocr_dashboard.DetailsTab({
              actions_panel: this,
            ...
            let app = createApp(MatchTab_default2, {
              panel_manager: this.panel_manager,
              transaction: this.transaction,
              doc: this.doc
            });
  ...
  // ../etransactions/etransactions/public/js/dashboard/actions_panel/details_tab.js
  frappe.provide("etransactions.ocr_dashboard");
  etransactions.ocr_dashboard.DetailsTab = class DetailsTab {
    constructor(opts) {
      $.extend(this, opts);
      this.make();
    }
    ...
    async update_ocr_request() {
      await frappe.call({
        method: "etransactions.etransactions.doctype.ocr_reconciliation_dashboard.ocr_reconciliation_dashboard.update_ocr_request",
        args: {
...
* @license MIT
**/
//# sourceMappingURL=ocr_dashboard.bundle.RKBXDGUE.js.map
